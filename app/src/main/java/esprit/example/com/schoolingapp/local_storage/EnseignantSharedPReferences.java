...
public class EnseignantSharedPReferences {
    ...
    public static final String USER_FILE = "enseignant";
    ...
    public EnseignantSharedPReferences(SharedPreferences sharedPreferences) {
        this.sharedPreferences = sharedPreferences;
    }
    ...
    public void logIn(Enseignant user) {
        this.insertString(USER_FIRST_NAME, user.getName());
        insertString(USER_LAST_NAME, user.getLast_name());
    //    insertString(USER_PASSWRD, user.getP());
        insertString(EMAIL, user.getE_mail());
       // insertString(USER_BIRTHDATE, user.get().toString());
